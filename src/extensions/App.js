  ...
  return (
    <Router history={history}>
      <Switch>
        ...
        <Route path="/address" exact component={() => <Address sdk={sdk || addressMockSdk} locations={locations} />} />
        ...
        />
        <Route path="/operating-hours" exact component={() => <OperatingHours sdk={sdk || operatingHoursMockSdk} />} />
        <Route
          path="/person-name"
          exact
