const mockSeoJson = {
  ...
  'description': {
    name: 'description',
    value:
      'Me non paenitet nullum festiviorem excogitasse ad hoc. Unam incolunt Belgae, aliam Aquitani, tertiam. Inmensae subtilitatis, obscuris et malesuada fames.'
  },
  'keywords': { name: 'keywords', value: 'These, are my, keywords' },
  'canonical': { name: 'canonical', value: 'https://www.lastrev.com' },
