  ...
  return (
    <>
      <Card className="operatingHours__newRowCard">
        <Form onSubmit={submit} className="operatingHours__newRowForm" testId="friendlyLabelsForm">
          ...
          {value ? (
            <>
              <Button buttonType="primary" type="submit" testId="friendlyLabelsForm-editButton">
                Save Edit
              </Button>
              <Button
                buttonType="muted"
            ...
            <Button buttonType="primary" type="submit" testId="friendlyLabelsForm-addButton">
              Add Friendly Label
            </Button>
          )}
        </Form>
