...
function RowEditForm({ value, onSubmit, onCancel, alreadySelectedDates }) {
  ...
  return (
    <>
      {errorMessage && (
        <Note className="operatingHours__newRowError" noteType="negative">
          {errorMessage}
        </Note>
      )}
      <Card className="operatingHours__newRowCard">
        <Form onSubmit={submit} className="operatingHours__newRowForm" testId="overrideDaysForm">
          ...
          {value ? (
            <>
              <Button testId="overrideDaysForm-editButton" buttonType="primary" type="submit">
                Save Edit
              </Button>
              <Button
            ...
            <Button testId="overrideDaysForm-addButton" buttonType="primary" type="submit">
              Add Special Date
            </Button>
          )}
        </Form>
