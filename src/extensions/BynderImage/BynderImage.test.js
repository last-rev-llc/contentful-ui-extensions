...
describe('<BynderImage />', () => {
  ...
  it('should update the fields when the Bynder Image is changed externally', () => {
    ...
    expect(sdk.entry.fields.imageName._value).toEqual(mockBynderData[0].name);
    expect(sdk.entry.fields.altText._value).toEqual(mockBynderData[0].description);
    expect(sdk.entry.fields.internalTitle._value).toEqual(mockBynderData[0].name);
    expect(sdk.entry.fields.altTextOverride._value).toEqual(mockBynderData[0].description);
  });
});
