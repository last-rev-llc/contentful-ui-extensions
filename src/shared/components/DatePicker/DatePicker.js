...
function DatePicker({ name, placeholderText, selected, onChange, minDate, excludeDates, className }) {
  ...
  class CustomInput extends React.Component {
    render() {
      ...
      return (
        <TextInput value={value} onClick={onClick} onChange={onChange} placeholder={placeholderText} width="small" />
      );
    }
  }
